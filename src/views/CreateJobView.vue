...
<!-- or posting duration, we can offer more flexible options:
...
60 days (2 months)
90 days (3 months)
Custom (with a date picker) -->
<!-- add preview button -->
<!-- add mode: negotitable or salay min max -->
<!-- add category -->
<!-- add application instruction: how can candiate apply -->
<!-- posting duration -->
